...
# SERVO_ESC|DC_STEER_THROTTLE|DC_TWO_WHEEL|SERVO_HBRIDGE_PWM|PIGPIO_PWM|MM1|MOCK
...
# (ps3|ps4|xbox|nimbus|wiiu|F710|rc3|MM1|custom) custom will run the my_joystick.py controller written by the `donkey createjs` command
...
#ROBOHAT MM1
# set to true when using the Robo HAT MM1 from Robotics Masters.  This will change to RC Control.
HAVE_ROBOHAT = False
